CLASS zcljs_deep_action_2nd DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    INTERFACES
      if_oo_adt_classrun.
    TYPES tt_document TYPE TABLE FOR ACTION IMPORT ZCJS_I_RAPCInvoice~CreateMultipleInvoices.
  PROTECTED SECTION.
  PRIVATE SECTION.
ENDCLASS.
...
CLASS ZCLJS_DEEP_ACTION_2ND IMPLEMENTATION.
