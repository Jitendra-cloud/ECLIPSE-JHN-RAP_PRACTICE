...
CLASS lcl_local_events DEFINITION INHERITING FROM cl_abap_behavior_event_handler.
  PRIVATE SECTION.
    TYPES ts_parameter TYPE STRUCTURE FOR EVENT zcjs_r_currency\\currency~afterexcelload.
...
CLASS lcl_local_events IMPLEMENTATION.
  ...
  METHOD get_receiver.
    SELECT SINGLE FROM ZCJS_I_BusinessUserVH
  ...
  METHOD get_mail_content.
    READ ENTITIES OF ZCJS_R_Currency
         ENTITY Currency
