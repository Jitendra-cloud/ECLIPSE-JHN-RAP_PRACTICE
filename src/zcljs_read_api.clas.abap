CLASS zcljs_read_api DEFINITION PUBLIC FINAL CREATE PUBLIC .

  PUBLIC SECTION.

    INTERFACES: if_oo_adt_classrun.

    TYPES: BEGIN OF post_s,
             user_id TYPE i,
             id      TYPE i,
             title   TYPE string,
             body    TYPE string,
    ...
    METHODS:
      ...
      read_posts RETURNING VALUE(result) TYPE post_tt
                 RAISING   cx_static_check,
...
CLASS ZCLJS_READ_API IMPLEMENTATION.
